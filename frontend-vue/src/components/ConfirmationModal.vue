...
const { icon, iconColor, iconBg, confirmButtonClass } = getIconAndColors()
</script>
...
<template>
  ...
  >
    ...
    >
      ...
      <!-- Modal Body (Optional, can be used for more content) -->
      <div class="px-6 py-4">
        <div class="flex items-start">
          <div class="flex-shrink-0">
            <span class="material-icons-outlined text-xl mt-0.5" :class="iconColor">help_outline</span>
          </div>
          <div class="ml-3 text-sm text-gray-600 dark:text-gray-300">
      ...
      <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 rounded-b-lg">
        <div class="flex justify-end space-x-3">
          ...
          <button
            ...
            @click="handleConfirm"
            :disabled="isLoading"
            class="px-4 py-2 text-sm font-medium text-white border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
