      ...
      <div v-if="showRejectItemModal" class="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" @click.self="closeRejectItemModal">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border-2 border-gray-200 dark:border-gray-700 w-full max-w-md p-6">
          ...
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Defective quantity <span class="text-red-500 dark:text-red-400">*</span>
          </label>
          <input
            ...
            class="w-full px-3 py-2 rounded-lg border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white mb-3 transition-all"
          />
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">
            {{ Math.max(0, rejectItemMaxQty - (parseInt(rejectItemDefectiveQty, 10) || 0)) }} unit(s) will remain for approval.
          </p>
