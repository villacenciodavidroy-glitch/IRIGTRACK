...
onMounted(async () => {
  ...
  console.log('EditItems component mounted with UUID:', itemId.value)
...
<template>
  <div class="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-semibold text-green-600">Edit Item Details</h1>
    ...
    <!-- Form -->
    <div v-else-if="currentItem" class="bg-white rounded-lg shadow p-6">
