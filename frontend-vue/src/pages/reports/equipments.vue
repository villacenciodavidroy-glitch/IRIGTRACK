      ...
      <div class="px-6 py-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div class="flex items-start gap-4">
          ...
          <div class="text-white">
            <h1 class="text-3xl font-extrabold leading-tight">Equipment Monitoring Report</h1>
            <p class="text-white/90 text-base mt-1">Track equipment inventory, value, and condition</p>
          </div>
        </div>
