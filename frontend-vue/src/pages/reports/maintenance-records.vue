...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 pb-8 print-area">
    <!-- Header Section -->
    ...
    <div class="p-4 sm:p-6">
      ...
      <!-- Empty State -->
      <div v-else-if="records.length === 0" class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 p-12">
        <div class="flex flex-col items-center justify-center">
          <span class="material-icons-outlined text-6xl text-gray-400 dark:text-gray-500 mb-4">build</span>
          <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">No maintenance records found</h3>
          <p class="text-gray-600 dark:text-gray-400 text-center">{{ searchQuery ? 'Try adjusting your search query' : 'No maintenance records available.' }}</p>
        </div>
      </div>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/30">
              <tr>
                <th class="px-6 py-3 text-left text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">ITEM NAME</th>
                <th class="px-6 py-3 text-left text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">REPORT DATE</th>
                <th class="px-6 py-3 text-left text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">REASON</th>
                <th class="px-6 py-3 text-left text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">CONDITION BEFORE</th>
                <th class="px-6 py-3 text-left text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">CONDITION AFTER</th>
                <th class="px-6 py-3 text-left text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">TECHNICIAN NOTES</th>
              </tr>
            </thead>
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="(record, index) in records" :key="record.id" :class="index % 2 === 0 ? 'bg-white dark:bg-gray-800' : 'bg-emerald-50/40 dark:bg-emerald-900/10'">
                <td class="px-6 py-4">
                  <div class="flex items-center gap-2">
                    <span class="material-icons-outlined text-gray-500 dark:text-gray-400 text-lg">inventory_2</span>
                    <div>
                      <div class="text-sm font-medium text-gray-900 dark:text-white">{{ record.item_unit }}</div>
                ...
                <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">{{ record.reason }}</td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">{{ record.technician_notes || 'N/A' }}</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-4 flex-wrap">
              <div class="flex items-center gap-2 text-sm text-emerald-900 dark:text-emerald-200 bg-white dark:bg-gray-800 border border-emerald-100 dark:border-emerald-800 px-4 py-2 rounded-full shadow-sm">
                <span class="material-icons-outlined text-emerald-600 dark:text-emerald-400 text-base bg-emerald-50 dark:bg-emerald-900/30 rounded-full p-1 border border-emerald-100 dark:border-emerald-800 shadow-sm">info</span>
    ...
    <!-- Footer Section -->
    <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 shadow-sm print:hidden rounded-xl mx-4 sm:mx-6 mt-4">
      <div class="px-6 py-3 flex items-center justify-center">
        <div class="flex items-center gap-2 text-emerald-800 dark:text-emerald-200 font-semibold">
          <span class="material-icons-outlined text-lg text-emerald-700 dark:text-emerald-400">task_alt</span>
